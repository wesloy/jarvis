Public Class frmCadReceitasDespesas
    Private dto As New dto_receitas_despesas
    Private bll As New bll_receitas_despesas
    Private hlp As New Uteis.Helpers
    Private filtro As String = ""
    Private camposObrigatorios As String = "txtDescricao;cbxTipoRegistro"
    ...
    Private Function salvarRegistro(ByVal tipoManutencao As Integer) As Boolean
        ...
        If hlp.validaCamposObrigatorios(Me, camposObrigatorios) Then
            ...
            With dto
                ...
                .tipoRegistro = Me.cbxTipoRegistro.Text.Trim
            ...
            With bll
                If .SalvarRegistro(dto) Then
                    ...
                    salvarRegistro = True
                Else
                    MsgBox("A manutenção no registro: " & Me.txtDescricao.Text.ToUpper & " não pode ser realizada!", MsgBoxStyle.Exclamation, TITULO_ALERTA)
    ...
    End Function
    Private Sub frmCadReceitasDespesas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        bloqueiaBotoes()
        hlp.limparCampos(Me)
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        Else
            ...
            With dto
                ...
                Me.cbxTipoRegistro.Text = .tipoRegistro
