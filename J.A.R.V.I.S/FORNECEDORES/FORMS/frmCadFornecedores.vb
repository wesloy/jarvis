Public Class frmCadFornecedores
    ...
    Private bll As New bll_fornecedores
    Private hlp As New Uteis.Helpers
    Private filtro As String = ""
    Private camposObrigatorios As String = "txtFornecedor;txtSigla"
    ...
    Private Function salvarRegistro(ByVal tipoManutencao As Integer) As Boolean
        ...
        If hlp.validaCamposObrigatorios(Me, camposObrigatorios) Then
            ...
            With dto
                .fornecedor = Me.txtFornecedor.Text.Trim
                .sigla = hlp.desacentua(Me.txtSigla.Text.Trim)
                .telefone = Me.txtTelefone.Text.Trim
                .celular = Me.txtCelular.Text.Trim
                .contato = Me.txtContato.Text.Trim
                .email = Me.txtEmail.Text.Trim
                .site = Me.txtSite.Text.Trim
                .horarioFuncionamento = Me.txtHorarioFunc.Text.Trim
                .cnpj = Me.txtCnpj.Text.Trim
            ...
            With bll
                If .SalvarRegistro(dto) Then
                    ...
                    salvarRegistro = True
                Else
                    MsgBox("A manutenção no registro: " & Me.txtFornecedor.Text.ToUpper & " não pode ser realizada!", MsgBoxStyle.Exclamation, TITULO_ALERTA)
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        Else
            ...
            With dto
                Me.txtID.Text = .id
                Me.txtFornecedor.Text = .fornecedor
                Me.txtSigla.Text = .sigla
                Me.txtTelefone.Text = .telefone
                Me.TxtCelular.Text = .celular
                Me.txtContato.Text = .contato
                Me.txtEmail.Text = .email
                Me.txtSite.Text = .site
                Me.txtHorarioFunc.Text = .horarioFuncionamento
